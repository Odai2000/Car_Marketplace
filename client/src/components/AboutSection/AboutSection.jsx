    ...
    return(
        ...
        <section className="AboutSection">
            ...
            <div className="AboutSection-container">
                <div className="item"><img src="src\components\AboutSection\assets\world.svg"/><p>Active particpation from more than <b>150 countries</b> around the globe creating <b>800+ post daily</b></p></div>
